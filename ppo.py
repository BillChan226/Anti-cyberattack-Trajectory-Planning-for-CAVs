...
#     # )
#     env = simple_multi_v2.parallel_env(
...
#     """ RENDER THE POLICY """
#     env = simple_multi_v2.parallel_env(continuous=False)#(render_mode="human", continuous=False)
#     env = color_reduction_v0(env)
...
#     env = simple_multi_v2.env()#(render_mode="human")
...
def _get_agents(
    ...
    #print("observation_space", observation_space["observation"])
